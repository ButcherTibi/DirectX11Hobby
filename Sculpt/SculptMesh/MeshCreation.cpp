...
void SculptMesh::init()
{
	...
	// GPU Verts
	{
		...
		gpu_verts.create(r.dev.Get(), r.im_ctx.Get(), desc);
	}
	...
	// GPU Index Buffer
	{
		...
		gpu_indexes.create(r.dev.Get(), r.im_ctx.Get(), desc);
	}
	...
	// GPU Tesselation Triangles
	{
		...
		gpu_triangles.create(r.dev.Get(), r.im_ctx.Get(), desc);
	}
	...
	// GPU Debug Octree Verts
	{
		...
		gpu_aabb_verts.create(r.dev.Get(), r.im_ctx.Get(), desc);
	}
}
