...
ErrorStack vks::PipelineLayout::create(LogicalDevice* logical_dev, DescriptorSetLayout* descp_layout)
{
	...
	pipeline_layout_info.pSetLayouts = &descp_layout->descp_layout;
...
ErrorStack vks::ShaderModule::create(LogicalDevice* logical_dev, std::vector<char>& code, VkShaderStageFlagBits stage)
{
	this->logical_dev = logical_dev;
	this->stage = stage;
...
vks::GraphicsPipeline::GraphicsPipeline()
{
	...
	// Color Blending state
	{
		...
		color_blend_state_info.logicOp = VK_LOGIC_OP_MAX_ENUM;
...
ErrorStack vks::GraphicsPipeline::create(LogicalDevice* logical_dev, ShaderModule* vertex_module, ShaderModule* frag_module,
