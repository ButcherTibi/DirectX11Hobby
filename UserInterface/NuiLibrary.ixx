...
export module NuiLibrary;

import GPU_ShaderTypes;
import CharacterAtlas;
import Input;
import Properties;
import MathStuff;
import Misc;
...
namespace nui {
	...
	export typedef std::variant<
		Root, Text, Stack, Flex, Menu, Rect, TreeList, Button, Slider
	> StoredElement;
	...
	public:
		...
		// Not sure if shadow DOM is that usefull
		// Element* _shadow_root;
		// std::unordered_set<Element*> _shadow_leafs;
		// std::map<uint32_t, std::list<Element*>> _shadow_draw_stacks;
	...
	public:
		...
		// void _shadowEmitEvents();
		// void _shadowTopDownPass();
		// void _shadowBottomUpPass();
		// void _shadowCalcDrawPosition();
		// void _shadowDraw();
		
		// virtual void emitEvents();
		// virtual void topDownPass();
		// virtual void bottomUpPass();
		// virtual void calcDrawPosition();
		// virtual void draw();
	};
	...
	export struct EventCreateInfo {
		EventCallback callback = nullptr;
		void* user_data;
	};
	 
	//export struct EventsCreateInfo {
	//	void setMouseEnterEvent(EventCallback callback, void* user_data = nullptr);
	//	void setMouseHoverEvent(EventCallback callback, void* user_data = nullptr);
	//	void setMouseMoveEvent(EventCallback callback, void* user_data = nullptr);
	//	void setMouseScrollEvent(EventCallback callback, void* user_data = nullptr);
	...
	public:
		...
		struct CreateInfo : public ElementCreateInfo {
			...
			AnimatedProperty<Color> track_background_color = nui::Color::transparentWhite(.5f);
			uint32_t track_fill_thickness = 7;
			AnimatedProperty<Color> track_fill_color = nui::Color::transparentWhite(.75f);
	...
	export class Dropdown : public ElementCreateInfo {
	public:
		struct CreateInfo : public ElementCreateInfo {
	...
	struct Root : Container {
		...
		// void topDownPass() override;
		// void bottomUpPass() override;
		// void calcDrawPosition() override;
		// void draw() override;
	};
	...
	public:
		...
		std::list<Slider::RetainedState> slide_prevs;
