...
namespace nui {
	...
	export using SteadyTime = std::chrono::time_point<std::chrono::steady_clock>;


	export inline uint32_t toMs(std::chrono::nanoseconds duration_ns)
	{
	...
	void Input::setKeyDownState(uint32_t wParam, uint32_t)
	{
